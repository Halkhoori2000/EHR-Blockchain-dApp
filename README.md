# EHR Blockchain dApp — Solidity, React, Polygon
...
**Address:** [`0x10E268d0EB3CD00746bF9b658324Acd585Af4166`](https://polygonscan.com/address/0x10E268d0EB3CD00746bF9b658324Acd585Af4166)
...
├── src/
│   ├── SmartContract/
│   │   └── SmartContract.sol      ← Solidity EHR contract (deployed on Polygon)
│   └── Frontend/
│       ├── src/
...
**Requirements:** Node.js, MetaMask browser extension connected to Polygon Mainnet.
