...
export const DeoHeading = "Add Deo Heading";
export const DeoText = "Add Deo Text";
export const FaqQuestion = "Add Question";
export const FaqAnswer = "Add Answer";
export const CrmName = "Add Name";
export const CrmMessage = "Add Message";
