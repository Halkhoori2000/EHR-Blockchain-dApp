...
import { StaticColumns } from "./prescriptions_list_Data";
...
function List() {
        ...
        <div style={flexboxstyle}>
          {userType == 1 ?
            <Button style={style2} type="button" color="success" size="sm" onClick={() => {
              navigate('/ehr/addPrescription', { state: { dataObj: elem } })
            }}>View Prescription</Button>
            :
            <Button style={style2} type="button" color="success" size="sm" onClick={() => {
              navigate('/ehr/uploadReports', { state: { dataObj: elem } })
  ...
  return (
    <Fragment>
      <Breadcrumbs
        parent="Prescriptions Section"
        title="Prescriptions List"
        mainTitle="Prescriptions List"
      />
