                ...
                <Card>
                    ...
                    <CardBody >
                        <div className="clipboaard-container">
                            ...
                            <Input className="form-control" id="clipboardExample1" type="text" placeholder="type some text to copy / cut" value={state.value}
                            ...
                            <div className="mt-3">
                                ...
                                <CopyToClipboard text={state.value}
                                    onCopy={() => setState({ copied: true, value: '' })}>
                                    <Button className="btn-clipboard-cut" color="secondary"><i className="fa fa-cut"></i> Cut</Button>
                                </CopyToClipboard>
                            </div>
                        </div>
                    </CardBody>
