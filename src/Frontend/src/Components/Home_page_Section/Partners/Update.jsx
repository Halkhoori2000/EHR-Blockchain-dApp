...
import { updatePartnersAPI } from "../../../api/api";
...
const Update = ({ listId }) => {
  ...
  const onHandleSubmit = async (e) => {
    ...
    await updatePartnersAPI(listId, formData);
  ...
  const populateData = () => {
    if (ifExists) {
      setUrl(ifExists?.dataObj.partnerssection_url);
      setSerialNumber(ifExists?.dataObj.partnerssection_serialnumber);
      setImgSave(ifExists?.dataObj.partnerssection_image);
    }
  };
